        ...
        <li class="cart-nav onhover-dropdown">
          ...
          <div class="cart-dropdown onhover-show-div">
            ...
            <ul>
              ...
              <li class="text-center"><a class="d-block mb-3 view-cart f-w-700" href="<?= base_url("ecommerce/cart") ?>">Go to your cart</a><a class="btn btn-primary view-checkout" href="<?= base_url("ecommerce/checkout") ?>">Checkout</a></li>
            </ul>
          </div>
        </li>
        <li class="onhover-dropdown">
