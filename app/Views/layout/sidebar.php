        ...
        <ul class="sidebar-links" id="simple-bar">
          ...
          <li class="sidebar-list"><i class="fa fa-thumb-tack"></i>
            ...
            <ul class="sidebar-submenu">
              <li><a class="lan-4" href="<?= base_url("dashboards/default-dashboard") ?>">Default</a></li>
              <li><a class="lan-5" href="<?= base_url("dashboards/ecommerce") ?>">Ecommerce</a></li>
              <li><a href="<?= base_url("dashboards/online_course") ?>">Online course</a></li>
              <li><a href="<?= base_url("dashboards/crypto_dashboard") ?>">Crypto</a></li>
              <li><a href="<?= base_url("dashboards/social_dashboard") ?>">Social</a></li>
            </ul>
          </li>
          ...
          <li class="sidebar-list"><i class="fa fa-thumb-tack"></i>
            ...
            <ul class="sidebar-submenu">
              ...
              <li><a href="<?= base_url("projects/project-create") ?>">Create new</a></li>
            </ul>
          </li>
